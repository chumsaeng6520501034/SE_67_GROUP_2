...
<body class="relative w-full h-screen bg-cover bg-center"
    ...
    <div
        class="absolute top-0 left-1/2 transform -translate-x-1/2 mt-10 w-full max-w-lg sm:max-w-xl md:max-w-2xl bg-white bg-opacity-50 backdrop-blur-md p-6 rounded-2xl shadow-lg overflow-y-auto max-h-[90vh]">
