            ...
            <div class="max-w-7xl mx-auto flex flex-col space-y-3 p-4 bg-white/10 backdrop-blur-2xl rounded-lg">
                <form action="/userFilterSearch" method="GET">
                    ...
                    <div class="flex justify-between items-center w-full">
                        ...
                        <button type="submit"
                            class="bg-blue-900 text-white px-4 py-2 rounded-lg font-bold hover:bg-blue-700 transition duration-300">SEARCH</button>
                    </div>
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 items-center mt-2">
                        ...
                        <!-- จำนวนคน -->
                        <div class="flex items-center space-x-1">
                            <label for="people" class="text-white font-bold">People:</label>
