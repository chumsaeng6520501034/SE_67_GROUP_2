...
<body class="relative w-full h-screen bg-cover bg-center"
    ...
    <div class="absolute inset-0 flex items-center justify-center bg-black bg-opacity-30">
        ...
        <div
            ...
            <h2 class="text-center text-4xl font-bold text-[#002D62] mb-6">ADD PRIVATE TOUR</h2>

            <form action="/guideAddPrivateTour" method="POST" enctype="multipart/form-data">
                @csrf
                <!-- Row 1 -->
                <div class="grid grid-cols-2 gap-4 mb-4">
                    <div>
                        <label class="block text-gray-700 font-medium">Tour Name*</label>
                        <input type="text" name="tour_name" class="w-full p-2 border rounded shadow-sm" readonly
                            value={{ $offerData->name }}>
                    </div>
                    <div>
                        <label class="block text-gray-700 font-medium">Price*</label>
                        <input type="number" name="price" class="w-full p-2 border rounded shadow-sm" readonly
                ...
                <div class="grid grid-cols-2 gap-4 mb-4">
                    <div>
                        ...
                        <input type="date" name="start_date" class="w-full p-2 border rounded shadow-sm" readonly
                            value={{ $offerData->start_tour_date }}>
                    </div>
                    <div>
                        <label class="block text-gray-700 font-medium">End Date*</label>
                        <input type="date" name="end_date" class="w-full p-2 border rounded shadow-sm" readonly
                ...
                <div class="grid grid-cols-2 gap-4 mb-4">
                    ...
                    <div>
                        ...
                        <input type="number" name="hotelPrice" min="1"
                            class="w-full p-2 border rounded shadow-sm" readonly value={{ $offerData->hotel_price }}>
                    </div>
                </div>
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" class="w-full p-2 border rounded shadow-sm" name="travel_by"
                ...
                <div class="grid grid-cols-2 gap-4 mb-4">
                    <div>
                        ...
                        <input type="number" name="quantity" class="w-full p-2 border rounded shadow-sm" readonly
                            value={{ $offerData->size_tour }}>
                    </div>
                    <div>
                        <label class="block text-gray-700 font-medium">Contact</label>
                        <input type="text" name="contact" class="w-full p-2 border rounded shadow-sm" readonly
                            value={{ $offerData->contect }}>
                    </div>
                </div>
                <div class="mb-4">
                    <label class="block text-gray-700 font-medium">Image</label>
                    <input type="file" name="image" id="imageInput" class="w-full p-2 border rounded shadow-sm">
                </div>
                <div class="mt-2">
