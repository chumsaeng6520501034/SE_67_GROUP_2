            ...
            <div class="bg-white bg-opacity-20 backdrop-blur-md p-6 rounded-2xl shadow-lg w-4/5 transition-all duration-300">
                ...
                <form action="/guideSearchAllPayment" method="get">
                    <div class="flex items-center space-x-4 mb-4 bg-white bg-opacity-50 p-3 rounded-lg shadow-lg w-full">
                        ...
                        <div class="flex items-center px-2 text-blue-900 text-xl mx-4">
                        ...
                        <tr class="text-center">
                            ...
                            <td class="border border-white px-4 py-2">
                                <form action="/guideGetPaymentDetail" method="GET">
                                    ...
                                    <button type="submit" class="bg-green-700 text-white font-bold py-2 px-6 rounded-lg hover:bg-green-600 ">
                                        View Receipt
                                    </button>
                                </form>
                            </td>
