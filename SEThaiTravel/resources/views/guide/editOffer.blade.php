...
<body class="relative w-full h-screen bg-cover bg-center"
    ...
    <div class="absolute inset-0 flex items-center justify-center bg-black bg-opacity-30">
        ...
        <div
            ...
            <form action="/guideUpdateOffer" method="POST">
                @csrf
                <!-- Row 1 -->
                ...
                <div class="grid grid-cols-2 gap-4 mb-4">
                    <div>
                        ...
                        <input type="text" class="w-full p-2 border rounded shadow-sm" name="travel" value={{$offerData->travel}}>
                    </div>
                    <div>
                        <label class="block text-gray-700 font-medium">Travel Price</label>
                        <input type="number" class="w-full p-2 border rounded shadow-sm" name="travel_price" value={{$offerData->travel_price}}>
                    </div>
                </div>
