...
class AccountController extends Controller
{
  ...
  { //ตรวจสอบการ login ว่าเป็น user ประเภทไหน แล้ว Redirect ไปที่หน้าของ Account ประเภทนั้น
    $request->validate(
      [
        'username' => 'required',
        'password' => 'required'
  ...
  { //Log out แล้ว เคลีย session ทิ้ง
  ...
  { //ดึงข้อมูลของTour ที่จะดูมาแล้ว Redirect ไปที่หน้าดูข้อมูลสินค้าพร้อมส่งข้อมูลที่ต้องการไปด้วย
